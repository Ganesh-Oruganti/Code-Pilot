...
async function sendOtpEmail(email, otp) {
	const mailOptions = {
		...
		to: email,
		subject: 'Code Pilot - Your OTP for Email Verification',
		html: `
            <html>
                <body>
                    <h2>Welcome to Our Code Pilot!</h2>
                    ...
                    <p><a href="https://online-ide-cyan.vercel.app/" target="_blank" style="color: #007BFF;">Code Pilot</a></p>
